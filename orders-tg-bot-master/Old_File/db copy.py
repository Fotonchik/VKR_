...
def admin_panel(message):
    ...
    if role_dict["admin"]:
        keyboard.add(types.InlineKeyboardButton("👥 Список администраторов", callback_data="list_admins"))
        keyboard.add(types.InlineKeyboardButton("❌ Удалить администратора", callback_data="delete_admin"))
        keyboard.add(types.InlineKeyboardButton("✏ Изменить имя администратора", callback_data="edit_admin"))
